...
public class FrameCavalos extends javax.swing.JFrame {
    
    private static FrameCavalos frameCavalos; 
    
    private FrameCavalos() {
        initComponents();
        this.setLocationRelativeTo(null);
    }
    
    public static FrameCavalos getFrameCavalos(){
        if(frameCavalos == null){
            frameCavalos = new FrameCavalos();
            return frameCavalos; 
        }
        return frameCavalos; 
    }
    ...
    private void initComponents() {
        ...
        txtField_Altura = new javax.swing.JTextField();
        ...
        txtField_Peso = new javax.swing.JTextField();
        ...
        lblTitulo.setText("Cadastro de Cavalos");

        lblNome.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        lblNome.setText("Nome do cavalo:");

        txtField_Altura.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtField_AlturaKeyTyped(evt);
            }
        });

        lblIdade.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        lblIdade.setText("Idade do cavalo:");
        ...
        txtField_Peso.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtField_PesoKeyTyped(evt);
            }
        });
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(lblPeso, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtField_Altura, javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(lblAltura, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    ...
                                    .addComponent(txtField_Peso, javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtField_Altura, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lblPeso)
                        .addGap(7, 7, 7)
                        .addComponent(txtField_Peso, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void btnRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRelatorioActionPerformed
        RelatorioCavalos relatorio = RelatorioCavalos.getRelatorioCavalos(); 
    ...
    private void txtField_AlturaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtField_AlturaKeyTyped
        apenasNumeros(evt); 
    }//GEN-LAST:event_txtField_AlturaKeyTyped

    private void txtField_PesoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtField_PesoKeyTyped
       apenasNumeros(evt); 
    }//GEN-LAST:event_txtField_PesoKeyTyped
    
    public void adicionar(){
        try{
            Cavalo cavalo = new Cavalo();
            receberValores(cavalo); 
            if(cadastroAnimais.buscarCavalo(cavalo.getNome()) == null){
                if(validarCampos() == true){
                    cadastroAnimais.adicionarCavalo(cavalo);
                    apagarCampos();
    ...
    public void editar(){
        try{
            Cavalo cavalo = cadastroAnimais.buscarCavalo(txtField_Busca.getText()); 
            if(cavalo != null){
               if(validarCampos() == true){
                    receberValores(cavalo); 
                    apagarCampos(); 
    ...
    public void excluir(){
        Cavalo cavalo = cadastroAnimais.buscarCavalo(txtField_Busca.getText()); 
        if(cavalo != null){
            cadastroAnimais.excluirCavalo(cavalo);
    ...
    public void receberValores(Cavalo cavalo){
        cavalo.setNome(txtField_Nome.getText());
        cavalo.setIdade(Integer.parseInt(txtField_Idade.getText()));
        cavalo.setAltura(Double.parseDouble(txtField_Altura.getText()));
        cavalo.setPeso(Double.parseDouble(txtField_Peso.getText())); 
        cavalo.setEspecie("Equidae");
        cavalo.setDataCadastro(txtField_DataCadastro.getText());
        cavalo.getDonoDoAnimal().setNome(txtField_NomeDono.getText());
        cavalo.getDonoDoAnimal().getEndereco().setRua(txtField_Rua.getText());
        cavalo.getDonoDoAnimal().getEndereco().setBairro(txtField_Bairro.getText());
        try{
            cavalo.getDonoDoAnimal().setCpf(txtField_Cpf.getText());
        }catch(CpfException ce){
            ce.messErro();
            ce.corrigirCpf(cavalo.getDonoDoAnimal()); 
        }
        try{
            cavalo.getDonoDoAnimal().getEndereco().setNumero(Integer.parseInt(txtField_NumeroCasa.getText()));
        }catch(NumeroException ne){
            ne.messErro();
            ne.corrigirNumCasa(cavalo.getDonoDoAnimal().getEndereco());
        }
    }
    
    public void atribuirValores(Cavalo cavalo){
        txtField_Nome.setText(cavalo.getNome()); 
        txtField_Idade.setText(Integer.toString(cavalo.getIdade())); 
        txtField_Peso.setText(Double.toString(cavalo.getPeso())); 
        txtField_DataCadastro.setText(cavalo.getDataCadastro()); 
        txtField_Altura.setText(Double.toString(cavalo.getAltura())); 
        txtField_NomeDono.setText(cavalo.getDonoDoAnimal().getNome());
        txtField_Cpf.setText(cavalo.getDonoDoAnimal().getCpf());
        txtField_Rua.setText(cavalo.getDonoDoAnimal().getEndereco().getRua()); 
        txtField_Bairro.setText(cavalo.getDonoDoAnimal().getEndereco().getBairro()); 
        txtField_NumeroCasa.setText(Integer.toString(cavalo.getDonoDoAnimal().getEndereco().getNumero())); 
    }
    ...
    public boolean validarCampos(){
        if(txtField_Nome.getText().equals("") || txtField_Idade.getText().equals("") ||
                        txtField_DataCadastro.getText().equals("") || txtField_Altura.getText().equals("") ||
                        txtField_Peso.getText().equals("") || txtField_NomeDono.getText().equals("") || 
    ...
    private javax.swing.JTextField txtField_Altura;
    ...
    private javax.swing.JTextField txtField_Peso;
